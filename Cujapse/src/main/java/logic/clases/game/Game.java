...
public class Game {
    ...
    public Game() {
        ...
        scenary = new Scenary();
        mainCharacter  = new PrincipalCharacter("0","User","/visualResources/personajes/player.png","/data/main_character/principal_dialogues.dat","/data/main_character/consecuencias.dat");
    }
